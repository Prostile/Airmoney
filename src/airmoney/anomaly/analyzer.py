...
def analyze_listing(
    ...
    return AnomalyResult(
        ...
        solo_requires_sweep=exit_result.requires_sweep,
        belongs_to_pack=bool(exit_result.pack_id),
        ...
        substitute_sample_size=exit_result.substitute_sample_size,
        substitute_last_scanned_at=exit_result.substitute_last_scanned_at,
        substitute_stale=exit_result.substitute_stale,
