...
def candidate_from_anomaly_result(
    ...
    return Candidate(
        ...
        solo_requires_sweep=result.solo_requires_sweep,
        belongs_to_pack=result.belongs_to_pack,
        ...
        substitute_sample_size=result.substitute_sample_size,
        substitute_last_scanned_at=result.substitute_last_scanned_at,
        substitute_stale=result.substitute_stale,
